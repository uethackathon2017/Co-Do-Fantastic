...
/**
 * Created by css2st on 17/12/2016.
 */
...
public class GPSTracker extends Service {
    ...
    private SettingIntent settingIntent;

    public GPSTracker() {
    }

    public GPSTracker(Context context, Activity activity, SettingIntent settingIntent) {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setPositiveButton("Settings", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                settingIntent.setOnShowSettingIntent();
            }
        });
    ...
    public interface SettingIntent {

        void setOnShowSettingIntent();
