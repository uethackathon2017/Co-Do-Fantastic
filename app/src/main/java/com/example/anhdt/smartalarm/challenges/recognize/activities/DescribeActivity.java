...
import com.example.anhdt.smartalarm.challenges.recognize.helper.SelectImageActivity;
    ...
    private class doRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            if (e != null) {
                ...
                boolean checkToothBrush = false;

                for (String tag: result.description.tags) {
                    if (tag.equals("cellphone")) {
                        checkToothBrush = true;
                        break;
                    }
                }

                if (checkToothBrush) {
                    Toast.makeText(DescribeActivity.this, "Success", Toast.LENGTH_LONG).show();
                }
                else {
                    Toast.makeText(DescribeActivity.this, "Failed", Toast.LENGTH_LONG).show();
                }
            }
